...
export default function HomeHeader() {
  return (
    <header className="fixed pt-6 top-0 w-93 left-1/2 -translate-x-1/2 z-50 bg-gradient-to-b from-black/80 via-black/50 to-transparent backdrop-blur-sm flex items-center">
